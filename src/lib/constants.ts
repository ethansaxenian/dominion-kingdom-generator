...
export const NON_SUPPLY_TYPES = ['Ally', 'Artifact', 'Boon', 'Curse', 'Event', 'Heirloom', 'Hex', 'Landmark', 'Prize', 'Project', 'Ruins', 'Shelter', 'State', 'Way', 'Zombie'];

export const CARD_SHAPED_TYPES = ['Ally', 'Event', 'Landmark', 'Project', 'Way'];
